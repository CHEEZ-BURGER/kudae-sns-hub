...
- 배포 완료 및 최근 배포의 **링크 복사**는 항상 요일이 포함된 `share/2045-thu.html#/d/토큰` 같은 주소를 만듭니다. 해당 HTML은 JS 실행 전부터 `og:title`과 고대신문 로고를 포함합니다. 웹앱·인증·Storage는 그대로 GitHub Pages + Supabase이며 추가 서비스/요금은 없습니다.
